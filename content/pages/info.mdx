...
blocks:
  ...
  - body: "# Školné\_\n\nMěsíční příspěvek je 9 280 Kč od září do června a pokrývá i fixní náklady na červenec a srpen kdy je škola zavřená a školné se neplatí.\n\nMaximální počet dětí je 15, a je pro nás důležité, aby dopoledne byli s dětmi vždy dva průvodci.\n"
    color: default
    _template: content
  - body: "# Prostory\_\n\nZázemí máme na adrese Elišky Přemyslovny 449 (v prostorách bývalé oční ordinace). Prostory jsou to hezké, dobře dostupné, ale bez zahrady. Hledáme tedy na Zbraslavi ještě prostor, kde by bylo možné vybudovat si komunitní školní zahradu.\n"
    color: default
    _template: content
