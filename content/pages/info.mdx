...
blocks:
  ...
  - body: "# Školné\_\n\nVýše školného se bude pohybovat kolem částky 8 500 Kč. Ještě musíme vše podrobně propočítat, až budeme znát veškeré výdaje.\n\n(Maximální počet dětí je 15, a je pro nás důležité, aby dopoledne byli s dětmi vždy dva průvodci. Zároveň jsme nově založeným spolkem, který nedosáhne na vnější finanční podporu. To vše se promítá do výše školného.)\_\n"
    color: default
    _template: content
  - body: "# Prostory\_\n\nZázemí budeme mít v prostorách současné oční ordinace, která se stěhuje pryč – Elišky Přemyslovny 449. Prostory jsou to hezké, dobře dostupné, ale bez zahrady. Hledáme tedy na Zbraslavi ještě prostor, kde by bylo možné vybudovat si komunitní školní zahradu.\n"
    color: default
    _template: content
  - body: "# Zápis\_\n\nPokud máte zájem přihlásit Vaše dítě do Habitatu, nebo být jen nezávazně informován o aktuálním dění, neváhejte nám napsat na [zapis@habitatzbraslav.cz](mailto\\:zapis@habitatzbraslav.cz).\_\n\nDne 12.4. proběhne na Zbraslavi setkání pro zájemce, kde bude možné potkat se osobně a zodpovědět veškeré otázky.\_\n"
    color: default
    _template: content
